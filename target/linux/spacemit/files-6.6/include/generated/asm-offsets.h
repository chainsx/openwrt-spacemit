...
#define TASK_THREAD_RA 2672 /* offsetof(struct task_struct, thread.ra) */
#define TASK_THREAD_SP 2680 /* offsetof(struct task_struct, thread.sp) */
#define TASK_THREAD_S0 2688 /* offsetof(struct task_struct, thread.s[0]) */
#define TASK_THREAD_S1 2696 /* offsetof(struct task_struct, thread.s[1]) */
#define TASK_THREAD_S2 2704 /* offsetof(struct task_struct, thread.s[2]) */
#define TASK_THREAD_S3 2712 /* offsetof(struct task_struct, thread.s[3]) */
#define TASK_THREAD_S4 2720 /* offsetof(struct task_struct, thread.s[4]) */
#define TASK_THREAD_S5 2728 /* offsetof(struct task_struct, thread.s[5]) */
#define TASK_THREAD_S6 2736 /* offsetof(struct task_struct, thread.s[6]) */
#define TASK_THREAD_S7 2744 /* offsetof(struct task_struct, thread.s[7]) */
#define TASK_THREAD_S8 2752 /* offsetof(struct task_struct, thread.s[8]) */
#define TASK_THREAD_S9 2760 /* offsetof(struct task_struct, thread.s[9]) */
#define TASK_THREAD_S10 2768 /* offsetof(struct task_struct, thread.s[10]) */
#define TASK_THREAD_S11 2776 /* offsetof(struct task_struct, thread.s[11]) */
...
#define TASK_THREAD_F0 2784 /* offsetof(struct task_struct, thread.fstate.f[0]) */
#define TASK_THREAD_F1 2792 /* offsetof(struct task_struct, thread.fstate.f[1]) */
#define TASK_THREAD_F2 2800 /* offsetof(struct task_struct, thread.fstate.f[2]) */
#define TASK_THREAD_F3 2808 /* offsetof(struct task_struct, thread.fstate.f[3]) */
#define TASK_THREAD_F4 2816 /* offsetof(struct task_struct, thread.fstate.f[4]) */
#define TASK_THREAD_F5 2824 /* offsetof(struct task_struct, thread.fstate.f[5]) */
#define TASK_THREAD_F6 2832 /* offsetof(struct task_struct, thread.fstate.f[6]) */
#define TASK_THREAD_F7 2840 /* offsetof(struct task_struct, thread.fstate.f[7]) */
#define TASK_THREAD_F8 2848 /* offsetof(struct task_struct, thread.fstate.f[8]) */
#define TASK_THREAD_F9 2856 /* offsetof(struct task_struct, thread.fstate.f[9]) */
#define TASK_THREAD_F10 2864 /* offsetof(struct task_struct, thread.fstate.f[10]) */
#define TASK_THREAD_F11 2872 /* offsetof(struct task_struct, thread.fstate.f[11]) */
#define TASK_THREAD_F12 2880 /* offsetof(struct task_struct, thread.fstate.f[12]) */
#define TASK_THREAD_F13 2888 /* offsetof(struct task_struct, thread.fstate.f[13]) */
#define TASK_THREAD_F14 2896 /* offsetof(struct task_struct, thread.fstate.f[14]) */
#define TASK_THREAD_F15 2904 /* offsetof(struct task_struct, thread.fstate.f[15]) */
#define TASK_THREAD_F16 2912 /* offsetof(struct task_struct, thread.fstate.f[16]) */
#define TASK_THREAD_F17 2920 /* offsetof(struct task_struct, thread.fstate.f[17]) */
#define TASK_THREAD_F18 2928 /* offsetof(struct task_struct, thread.fstate.f[18]) */
#define TASK_THREAD_F19 2936 /* offsetof(struct task_struct, thread.fstate.f[19]) */
#define TASK_THREAD_F20 2944 /* offsetof(struct task_struct, thread.fstate.f[20]) */
#define TASK_THREAD_F21 2952 /* offsetof(struct task_struct, thread.fstate.f[21]) */
#define TASK_THREAD_F22 2960 /* offsetof(struct task_struct, thread.fstate.f[22]) */
#define TASK_THREAD_F23 2968 /* offsetof(struct task_struct, thread.fstate.f[23]) */
#define TASK_THREAD_F24 2976 /* offsetof(struct task_struct, thread.fstate.f[24]) */
#define TASK_THREAD_F25 2984 /* offsetof(struct task_struct, thread.fstate.f[25]) */
#define TASK_THREAD_F26 2992 /* offsetof(struct task_struct, thread.fstate.f[26]) */
#define TASK_THREAD_F27 3000 /* offsetof(struct task_struct, thread.fstate.f[27]) */
#define TASK_THREAD_F28 3008 /* offsetof(struct task_struct, thread.fstate.f[28]) */
#define TASK_THREAD_F29 3016 /* offsetof(struct task_struct, thread.fstate.f[29]) */
#define TASK_THREAD_F30 3024 /* offsetof(struct task_struct, thread.fstate.f[30]) */
#define TASK_THREAD_F31 3032 /* offsetof(struct task_struct, thread.fstate.f[31]) */
#define TASK_THREAD_FCSR 3040 /* offsetof(struct task_struct, thread.fstate.fcsr) */
